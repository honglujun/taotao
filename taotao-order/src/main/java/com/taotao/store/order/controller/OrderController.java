...
public class OrderController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/query/{orderId}/{itemId}",method = RequestMethod.GET)
	public OrderItem queryOrderByUserIdAndItemId(@PathVariable("orderId") String orderId,@PathVariable("itemId") String itemId){
	    return orderService.queryOrderByUserIdAndItemId(orderId,itemId);
	} 
