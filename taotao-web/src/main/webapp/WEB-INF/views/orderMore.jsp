...
<body id="mainframe">
	...
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderItems[0].picPath"
			value="${item.image}" />
		<%-- <c:forEach items="${oderMore }" var="orders"> --%>
		...
		<input type="hidden" name="orderShipping.receiverName"
			value="${orderMore.buyerNick }" /> <input type="hidden"
			name="orderShipping.receiverMobile" value="15800000000" /> <input
			type="hidden" name="orderShipping.receiverState" value="上海" /> <input
	...
	<div class="w w1 header clearfix">
		...
		<div class="progress clearfix">
			...
			<ul>
				...
				<li><font color="red"><h1>淘淘商城订单详情</h1></font></li>
			</ul>
						...
						<div id="consignee" class="sbox-wrap">
							<div class="sbox">
								<div class="s-content">
									...
									<p>
										收货人&nbsp;&nbsp;：${oderMore.orderShipping.receiverName} <br />
										手机电话：${oderMore.orderShipping.receiverMobile } &nbsp; &nbsp; <br />
										收货地址：${oderMore.orderShipping.receiverState }
										${oderMore.orderShipping.receiverCity }
										${oderMore.orderShipping.receiverDistrict } &nbsp;
										${oderMore.orderShipping.receiverAddress } 
									</p>
								</div>
							</div>
						</div>
										...
										<span id="span-skulist">
											...
											<div class="review-body">
												...
												<div class="review-tbody">
													<table class="order-table">
														<tbody>
														<c:forEach items="${oderMore.orderItems }" var="om">
